    ...
    return (
        ...
        >
            <div className="flex items-center flex-1 space-x-16">
                <div>
                    <NavItem className="cursor-pointer" href="/">
                        <svg
                            width="42"
                            height="42"
                            viewBox="0 0 36 36"
                ...
                <div className="space-x-10 flex items-center w-full">
                    <NavList
                        className=""
                    ...
                    <div className="flex flex-1 justify-end">
                        <a
                            href="https://github.com/kransio/krans"
                            target="_blank"
                        >
                            <Github
                                className={classNames('h-8 w-8', itemClassName)}
                            />
                        </a>
                    </div>
                </div>
...
}> = ({ className, itemClassName, activeItemClassName, children }) => {
    return (
        <div className={classNames('flex justify-end space-x-10', className)}>
